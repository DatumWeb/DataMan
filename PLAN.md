...
- [x] **Active extract:** Up Arrow or `W` extracts the current platform; logs with `collection_mode = active_extract` and `event_type = extraction` (includes text preview, bbox, selector). TODO later: ~1s cast + small animation.
